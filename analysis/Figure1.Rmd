...
Define saving plots as pdfs and pngs
...
Figure 1D - yH2AX Quantification (Immunofluorescence Staining)
...
IF Quantification yH2AX Step 1 - ROI Level
...
Step 2 - Collapse to Image Level Summaries
...
Read in Dataframe of Image Level Summary
...
IF Quantification Step 2 - Image Level
...
IF Quantification Step 3 - Select Images with Consistent Nuclei per Individual
...
```
IF Quantification Step 6 - Add Significance Between Timepoints
...
Figure 1E - IF Images yH2AX from Individual 87-1 (Ind 1)
