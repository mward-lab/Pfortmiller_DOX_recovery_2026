...
out_folder <- "C:/Users/emmap/OneDrive/Desktop/DXR Manuscript Materials/Fig pdfs"
base_name <- "viability_curve_scaled"

# Full file paths
png_path <- file.path(out_folder, paste0(base_name, ".png"))
svg_path <- file.path(out_folder, paste0(base_name, ".svg"))
pdf_path <- file.path(out_folder, paste0(base_name, ".pdf"))
...
text(x = median_ld50, y = 99,
     labels = paste0("Median LD50 = ", round(median_ld50, 2), " µM"),
