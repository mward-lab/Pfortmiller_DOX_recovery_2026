...
proSus_set <- unique(proSus_overlap$Entrez_ID)
...
#   filename = "Sustained_Proportion_Barplot_proSus_newdef_DEGs_EMP",
#   folder = output_folder
# )
...
```{r GO KEGG proSus New}

proSus_gene_list <- proSus_df$Entrez_ID
length(proSus_gene_list) #147 genes after changing the definition
