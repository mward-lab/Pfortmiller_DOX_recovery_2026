...
#define DE gene sets
DOX_t0_RUV <- read.csv("data/new/DEGs/Toptable_RUV_24T_final.csv") %>% dplyr::select(-X)
DOX_24R_R <- read.csv("data/new/DEGs/Toptable_RUV_24R_final.csv") %>% dplyr::select(-X)
DOX_144R_R <- read.csv("data/new/DEGs/Toptable_RUV_144R_final.csv") %>% dplyr::select(-X)
...
# gene_annot <- combined_toptables_dxr_RUV$t0 %>% 
...
clust_GOKEGG_terms_list <- readRDS("data/new/RUV/CMF/cluster_GOKEGG_terms_geneids.RDS")
